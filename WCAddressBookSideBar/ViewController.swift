...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, WCAddressBookDelegate{
    ...
    var sideBar: WCAddressBookSideBar!
    ...
    override func viewDidLoad() {
        ...
        sideBar = WCAddressBookSideBar(frame: CGRect(x: view.frame.width - 15.0, y: 0, width: 15, height: view.frame.height))
